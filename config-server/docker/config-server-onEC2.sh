...
scp -i "C:\dev\test\keypairs\book-app-keyPair.pem" ./docker-compose.yaml ec2-user@ec2-3-137-156-108.us-east-2.compute.amazonaws.com:/home/ec2-user/
...
ssh -i "C:\dev\test\keypairs\book-app-keyPair.pem" ec2-user@ec2-3-137-156-108.us-east-2.compute.amazonaws.com
