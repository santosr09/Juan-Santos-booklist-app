...
scp -i "C:\dev\test\keypairs\book-app-keyPair.pem" ./docker-compose.yaml ec2-user@ec2-3-16-111-32.us-east-2.compute.amazonaws.com:/home/ec2-user/

#*********  CONNECT TO EC2 INSTANCE:  *************
#**************************************************

ssh -i "C:\dev\test\keypairs\book-app-keyPair.pem" ec2-user@ec2-3-16-111-32.us-east-2.compute.amazonaws.com
