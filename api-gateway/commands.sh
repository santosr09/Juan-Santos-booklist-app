...
docker build --tag=book-api-gateway --force-rm=true .

#BEFORE PUSH AN IMAGE TO A REPOSITORY, SHOULD BE TAGGED
docker tag <IMAGE-ID> santosr09/book-api-gateway
#docker tag 248748ae188a santosr09/books-api-gateway

#PUSH AN IMAGE TO THE REPOSITORY:
docker push santosr09/book-api-gateway

#RUN A CONTAINER
docker run -dp 8082:8082 santosr09/book-api-gateway
